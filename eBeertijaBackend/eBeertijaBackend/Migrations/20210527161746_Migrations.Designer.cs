...
namespace eBeertijaBackend.Migrations
{
    ...
    [Migration("20210527161746_Migrations")]
            ...
            modelBuilder.Entity("ebeertijaBackend.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            IsActive = true,
                            PasswordHash = new byte[] { 122, 193, 68, 72, 243, 185, 192, 123, 122, 225, 108, 170, 22, 24, 229, 249, 133, 100, 231, 71, 171, 180, 49, 49, 158, 186, 74, 192, 35, 3, 46, 77, 88, 49, 149, 36, 252, 245, 214, 76, 27, 37, 157, 25, 194, 152, 169, 148, 253, 245, 40, 10, 207, 151, 52, 191, 187, 84, 127, 35, 142, 202, 11, 209 },
                            PasswordSalt = new byte[] { 236, 26, 70, 114, 47, 237, 152, 92, 169, 125, 233, 121, 155, 218, 143, 49, 18, 32, 169, 184, 127, 103, 90, 29, 5, 83, 251, 184, 171, 93, 210, 46, 13, 206, 252, 76, 3, 24, 88, 2, 139, 231, 9, 109, 70, 122, 225, 207, 143, 201, 198, 108, 68, 117, 20, 161, 164, 208, 19, 8, 78, 33, 167, 162, 140, 41, 242, 236, 177, 151, 29, 49, 25, 70, 143, 73, 171, 70, 243, 198, 201, 82, 206, 154, 244, 79, 40, 126, 167, 68, 44, 23, 88, 50, 61, 211, 26, 99, 224, 183, 69, 146, 220, 18, 87, 164, 82, 58, 180, 50, 168, 78, 223, 44, 83, 192, 158, 208, 146, 153, 199, 181, 103, 98, 158, 238, 1, 152 },
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Username = "marin",
                            Vrsta = 1
                        },
